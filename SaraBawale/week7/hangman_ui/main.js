...
play = function(){
	...
	var r = $("<p>").addClass("render");
	var g = $("<p>").addClass("guesses");
	var u = $("<p>").addClass("used-words");

	$(".gameboard").append(r, g, u);
...
update = function(){
	$(".render").text(game.render());
	$(".guesses").text("Guesses left: " + game.guesses);
	$(".used-words").text("Incorrect letters: " + game.guessedLetters);
}

gameOver = function(){
	$(".gameboard").empty();

	var over = $("<p>").text(game.overMessage());
	$(".gameboard").append(over);
}
