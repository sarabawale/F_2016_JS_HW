...
//your function here!
function findLengths(array){
	var nums = [];
	for(var i=0; i<array.length; i++){
		var size = String(array[i]).length;
		nums.push(size);
	}
...
console.log(findLengths(titles));
//this should print [16, 16, 15, 15, 5, 11, 8, 35, 19, 15, 16, 10, 9]

//Bonus
var edges = [3, 2, "five"]
console.log(findLengths(edges));
//oops! this prints [undefined, undefined, "4"], how can you get it to print [1,1, 4] instead?